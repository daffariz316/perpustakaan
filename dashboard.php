...
<body>
    <div class="container">
        <div class="row">
            <div class="col">
                <br>
                <h1><center>PAS DAFFARIZQY</center></h1>
                <br>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12">
                ...
                if(isset($_GET['page'])){
                    if ($_GET['page']=="anggota") {
                        ...
                        include('petugas.php');
                    }elseif($_GET['page']=="delete_petugas"){
                        include('delete_petugas.php');
                    }elseif($_GET['page']=="edit_petugas"){
                        include('edit_petugas.php');
                    }elseif($_GET['page']=="edit_petugas_proses"){
                        include('edit_petugas_proses.php');
