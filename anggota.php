...
<table class="table table-striped table-hover">
    ...
    <?php
    ////query 3 table ////////
    //$querybaru= mysqli_query($konek,"SELECT anggota.nis, anggota.nama, anggota.jk, anggota.tpt_lahir, anggota.tgl_lahir, anggota.id_kelas,anggota.id_jurusan, anggota.tlp, anggota.alamat,kelas.nama_kelas,jurusan.nama_jurusan
    //from anggota
